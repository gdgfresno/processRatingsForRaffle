...
app.get('/process', function(req, res) {
  ...
  var partSorted = participants.sort(function(a, b) { return b.rank - a.rank; });

  fs.writeFile('raffleFeed.jsonp', 'participants=' + JSON.stringify(partSorted, null, 2), function (err) {
    if (err) {
      res.send(err);
    } else {
